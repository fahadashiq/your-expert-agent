...
export class ResPropertiesComponent implements OnInit {
  ...
  protected onSuccess(data: IResProperties[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
    this.totalItems = Number(headers.get('X-Total-Count'));
    this.page = page;
    if (navigate) {
      this.router.navigate(['/res-properties'], {
        queryParams: {
          page: this.page,
          size: this.itemsPerPage,
