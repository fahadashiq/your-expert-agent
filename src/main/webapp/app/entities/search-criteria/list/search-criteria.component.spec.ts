...
describe('Component Tests', () => {
  describe('SearchCriteria Management Component', () => {
    let comp: SearchCriteriaComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SearchCriteriaComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.searchCriteria?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
