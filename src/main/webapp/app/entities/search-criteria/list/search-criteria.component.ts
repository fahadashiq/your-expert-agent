...
export class SearchCriteriaComponent implements OnInit {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.searchCriteriaService
      ...
      .subscribe(
        (res: HttpResponse<ISearchCriteria[]>) => {
  ...
  trackId(index: number, item: ISearchCriteria): number {
    return item.id!;
  }

  delete(searchCriteria: ISearchCriteria): void {
    const modalRef = this.modalService.open(SearchCriteriaDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
  ...
  protected onSuccess(data: ISearchCriteria[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
