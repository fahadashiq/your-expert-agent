...
describe('Component Tests', () => {
  describe('CrimeReport Management Component', () => {
    let comp: CrimeReportComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CrimeReportComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.crimeReports?.[0]).toEqual(expect.objectContaining({ id: 123 }));
    });
