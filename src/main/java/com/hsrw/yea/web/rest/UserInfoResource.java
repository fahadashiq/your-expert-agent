...
import com.hsrw.yea.service.UserInfoService;
...
/**
 * REST controller for managing {@link com.hsrw.yea.domain.UserInfo}.
 */
@RestController
@RequestMapping("/api")
public class UserInfoResource {
    ...
    public ResponseEntity<UserInfoDTO> partialUpdateUserInfo(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, userInfoDTO.getId().toString())
        );
    }
